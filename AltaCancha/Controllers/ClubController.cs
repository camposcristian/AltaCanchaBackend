...
namespace AltaCancha.Controllers
{
    public class ClubController : ApiController
    {
        ...
        {
            var clubs = db.Clubs.Include("Amenities").Include("Courts.FloorType").Include("Courts.Type").Include("Photos").Include("HeaderPhoto").AsQueryable<Club>();
        ...
        public IHttpActionResult GetClub(int id)
        {
            ...
            var club = db.Clubs.Include("Amenities").Include("Courts.FloorType").Include("Courts.Type").Include("Photos").Include("HeaderPhoto").FirstOrDefault(p => p.Id == id);
            if (club == null)
            {
                return NotFound();
            }
